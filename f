...
local RobloxButton = Enum.ButtonStyle.RobloxRoundDropdownButton

ScreenGui.Parent = game.CoreGui
ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

-- กำหนด Stroke และ Corner
...
ImageButton.Image = "rbxassetid://13265033056" -- กำหนดรูปภาพให้กับ ImageButton
ImageButton.Style = RobloxButton -- กำหนด Style ให้กับ ImageButton


-- เมื่อคลิกปุ่มใน ImageButton
ImageButton.MouseButton1Down:connect(function()
    game.CoreGui:FindFirstChild("VectorHub").Enabled = not game.CoreGui:FindFirstChild("VectorHub").Enabled
end)
...
do
    if game:GetService("CoreGui"):FindFirstChild("VectorHub") then
        game:GetService("CoreGui").VectorHub:Destroy()
...
Main:TweenSize(UDim2.new(0, 550, 0, 250),"Out","Quad",0.4,true) 
...
UserInputService.InputBegan:Connect(function(input)
 ...
 Main:TweenSize(UDim2.new(0, 0, 0, 0),"In","Quad",0.4,true)
  ...
  uihide = false
 Main:TweenSize(UDim2.new(0, 550, 0, 250),"Out","Quad",0.5,true)
 end
 end
 end)
local uitab = {}
